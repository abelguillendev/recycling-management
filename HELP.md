...
* The original package name 'com.aguillen.recycling-management' is invalid and this project uses 'com.aguillen.recyclingmanagement' instead.
...
```
$ docker run --rm -p 8080:8080 recycling-management:0.0.1-SNAPSHOT
```
